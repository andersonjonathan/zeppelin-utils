    ...
    try:
        ...
        try:
            ...
            try:
                ...
                table += "<p>from pyspark.sql.types import StructType, NullType, StringType, BinaryType, BooleanType, DateType, TimestampType, \</p>"
                table += "<p>    DecimalType, DoubleType, FloatType, ByteType, IntegerType, LongType, ShortType, ArrayType, MapType</p>"
